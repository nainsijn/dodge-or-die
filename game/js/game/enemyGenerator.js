...
define(["enemy"], function (Enemy) {
	...
	/**
	 * The EnemyGenerator initialization.
	 * @param enemyLayer KineticJS Layer
	 * @param enemyGroup KineticJS Group
	 * @param foreground KineticJS Group
	 * @param attackCallback callback for attacking the player
	 * @param goToCallback callback for go-to target
	 * @param killCallback callback for when an enemy is killed
	 */
	EnemyGenerator.prototype.init = function (enemyLayer, enemyGroup, foreground, attackCallback, goToCallback, killCallback) {
	...
	EnemyGenerator.prototype.start = function () {
		...
		// set-up enemy-go-to interval (optimized for performance)
